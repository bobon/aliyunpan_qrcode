...
const (
	...
	console_black_background int  = 40 // 控制台 黑色 背景
	console_white_background int  = 47 // 控制台 白色 背景
	console_black_foreground int  = 30 // 控制台 黑色 前景
	console_white_foreground int  = 37 // 控制台 白色 前景
)
